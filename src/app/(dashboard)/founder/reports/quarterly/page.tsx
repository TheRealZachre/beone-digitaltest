...
export default async function FounderQuarterlyReportPage() {
  ...
  const posts = await getFounderPostsForTimeframe("quarterly");
    ...
    <>
      <Header
        ...
        actions={
          <ExportButtons
            posts={posts}
            reportTitle={`${brand.name} — Quarterly Executive Summary`}
            filenameBase="founder-quarterly-report"
            pptxData={{
              timeframe: "quarterly",
              title: `${brand.name} — Quarterly Executive Summary`,
      ...
      <div className="space-y-8 p-8" id="report-content">
        ...
        <div className="rounded-xl border-2 border-slate-900 bg-slate-900 p-8 text-white">
          ...
          <p className="mt-3 max-w-3xl text-slate-300">
            ...
            Published {summary.totalPosts} posts across LinkedIn &amp; X,
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            ...
            <ExecutiveMetric
              ...
              detail={`${summary.organicPosts} organic · ${summary.paidPosts} paid`}
            />
          </div>
        </div>
